...
void DayStats::write_header(ostream& o) {
  ...
  o << "DATE CROP_INCR CROP_TOTAL NUM_AREAS_IN_WIPEOUT MAX_NUM_PLACES_EATEN MAX_NUM_PLACES_EXPLORED DEATHS_AGE DEATHS_STARVE DEATH_STRAND BIRTHS POP TYPEA A_EN A_EATEN \n";
}
