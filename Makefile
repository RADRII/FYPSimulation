...
People_tester.o: People_tester.cpp Person.h Knowledge.h InfoRes.h AreaGain.h Resource.h Grid.h Action.h Util.h DayStats.h Debug.h CmdLineVersions.h $(QtVisDir)/world_show.h
	g++ -std=c++11 $(CPPFLAGS) $(INCPATH) $(QTCXXFLAGS) $(QTINCPATH) -c People_tester.cpp

People_tester: People_tester.o world_setup.o Grid.o Person.o Knowledge.o InfoRes.o AreaGain.o Resource.o Action.o Util.o DayStats.o Debug.o CmdLineVersions.o $(QtVisObjects)
	g++ -std=c++11 $(CPPFLAGS) $(QTCXXFLAGS) $(LIBPATH) People_tester.o world_setup.o Grid.o Person.o Knowledge.o InfoRes.o AreaGain.o Resource.o Action.o Util.o DayStats.o Debug.o CmdLineVersions.o $(LIBS) $(QtVisObjects) $(QTLFLAGS) $(QTLIBS) -o People_tester
...
Knowledge.o: Knowledge.cpp Knowledge.h InfoRes.h AreaGain.h Resource.h Grid.h Util.h Grid.h
...
InfoRes.o: InfoRes.cpp InfoRes.h AreaGain.h Resource.h
	g++ -std=c++11 $(CPPFLAGS) $(INCPATH) -c InfoRes.cpp

Person.o: Person.cpp Person.h Knowledge.h InfoRes.h AreaGain.h Resource.h Grid.h Util.h DayStats.h Debug.h
...
clean:
	rm -f People_tester.o world_setup.o Person.o Knowledge.o InfoRes.o AreaGain.o Resource.o Grid.o Action.o Util.o DayStats.o Debug.o CmdLineVersions.o People_tester
